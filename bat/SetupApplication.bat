...
:: Android packaging
set AND_CERT_NAME="SuperExGirlfriend"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SuperExGirlfriend.p12
...
set IOS_PROVISION=cert\SuperExGirlfriend.mobileprovision
...
set APP_ID=air.SuperExGirlfriend

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SuperExGirlfriend
